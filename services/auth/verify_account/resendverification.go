...
func (u *verifyService) ResendVerifyUserByToken(req dto.ResendVerificationRequest) (*entity.UserVerified, error) {

	resend := dto.ResendVerificationRequest{
	...
	user, err := u.Repo.ResendVerifyUserByToken(resend)
	if err != nil {
		return nil, err
	}
	user.Otp = resend.Otp
